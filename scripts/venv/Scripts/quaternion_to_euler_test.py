...
if not os.path.exists(file_path):
    ...
    for quat in quaternions:
        ...
        # Swap Roll and Yaw (euler[0] = Roll, euler[1] = Pitch, euler[2] = Yaw)
        euler_angles_deg.append([euler[2], euler[1], euler[0]])  # Swap Roll and Yaw
    ...
    df.to_excel("updated_data_with_corrected_euler_angles.xlsx", index=False)
